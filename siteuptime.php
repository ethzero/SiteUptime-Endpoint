...
<footer>
    <div class="panel" id="siteuptime">
        ...
        <a href='http://www.siteuptime.com/' target="_blank" onMouseOver='this.href="//www.siteuptime.com/statistics.php?Id=<?php echo $cfg['siteuptime']['Id']?>&UserId=<?php echo $cfg['siteuptime']['UserId']?>";'><img width=85 height=16 border=0 alt='website uptime' src="//btn.siteuptime.com/genbutton.php?u=<?php echo $cfg['siteuptime']['UserId']?>&m=<?php echo $cfg['siteuptime']['Id']?>&c=blue&p=total"></a><noscript><a href='//www.siteuptime.com/'>website monitoring</a></noscript>
    </div>
