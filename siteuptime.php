...
<footer>
    <div class="panel" id="siteuptime">
        ...
        <a href='http://www.siteuptime.com/' target="_blank" onMouseOver='this.href="http://www.siteuptime.com/statistics.php?Id=<?php echo $cfg['siteuptime']['Id']?>&UserId=<?php echo $cfg['siteuptime']['UserId']?>";'><img width=85 height=16 border=0 alt='website uptime' src="http://btn.siteuptime.com/genbutton.php?u=176288&m=1629&c=blue&p=total"></a><noscript><a href='http://www.siteuptime.com/'>website monitoring</a></noscript>
    </div>
